...
export default function HowItWorksPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-50 pt-12 overflow-x-hidden print:bg-white print:pt-0">
      
      {/* INNER CONTENT WRAPPER */}
      <div className="w-full flex flex-col items-center px-6 space-y-12 mb-24 print:space-y-8 print:mb-0">
        <SiteHeader />
        ...
        <section className="w-full max-w-5xl text-center space-y-4 pt-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-50 border border-teal-200 text-teal-800 font-bold text-xs uppercase tracking-wider">
            <Sparkles className="w-4 h-4 text-teal-600" /> Empowering Personalized Education
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight">
            How MiSpark Works & Why Educators Love It
          </h1>
          <p className="text-lg md:text-xl text-slate-600 font-medium max-w-3xl mx-auto leading-relaxed">
            Transform raw topics, worksheets, or PDFs into personalized, hands-on learning experiences mapped directly to your state standards and individual needs.
          </p>
        </section>
