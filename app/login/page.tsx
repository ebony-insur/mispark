      ...
      <form onSubmit={handleAuth} className="space-y-5">
        ...
        {isSignUp && (
          <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2">
            <div>
              <label className="text-sm font-bold text-slate-700 mb-1 block">First Name</label>
              <Input 
                type="text" 
                value={firstName} 
            ...
            <div>
              <label className="text-sm font-bold text-slate-700 mb-1 block">Last Name</label>
              <Input 
                type="text" 
                value={lastName} 
