...
export default function ResourcesHub() {
  ...
  const resources = [
    {
      ...
      link: "https://www.amazon.com/hz/audible/mlp/membership/plus?tag=mispark0a-20",
    ...
    },
    {
      ...
      link: "https://www.amazon.com/amazonprime?tag=mispark0a-20",
    ...
    },
    {
      ...
      link: "https://www.walmart.com/plus?affiliate_id=YOUR_WALMART_TAG", // Make sure to update this tag!
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-50 pt-12 overflow-x-hidden">
      
      {/* INNER CONTENT WRAPPER */}
      <div className="w-full flex-1 flex flex-col items-center px-6 space-y-8 mb-24 max-w-4xl">
        
        {/* Header */}
        <div className="w-full flex items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-slate-200">
          <button 
