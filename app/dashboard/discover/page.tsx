...
export default function DiscoverPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-slate-50 overflow-x-hidden pt-6">
      ...
      <div className="w-full flex-1 flex flex-col items-center px-6 mb-24">
        <div className="w-full flex justify-center mb-12">
          <SiteHeader />
        </div>

        {/* LEAD MAGNET HERO */}
        <section className="w-full max-w-3xl pb-8 text-center animate-in fade-in slide-in-from-bottom-4">
        ...
        {/* RESULTS & UPSELL */}
        {results && (
          <section className="w-full max-w-4xl space-y-12 animate-in fade-in slide-in-from-bottom-8">
